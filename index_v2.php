...
<body>
    <div class="card">
        ...
        <div class="info">
            ...
            <p><strong>Dibuat oleh:</strong> <?php echo "Muhammad Nabil Hilman"; ?></p>
        ...
        $nama_perpus   = "Perpustakaan Uin Gusdur";
        $total_buku    = 1250;
        $total_anggota = 450;
        $buku_dipinjam = 178;
        ...
        $alamat_perpus = "Jalan Raya Cepagan, Koata Batang";
        $telepon_perpus = "(021) 66352892";
        $jam_buka = "08:00";
        $jam_tutup = "17:00";
